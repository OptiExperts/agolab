...
(function( jQuery ){
  var $module = jQuery('#m-1656646345653').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    
    
(function(jQuery) {
  var $module = jQuery('#m-1656646345621').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1656646345783').children('.module');
  ...
  switch(style) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1656646345746').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1656646345708').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1656646345708').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1656646345708');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1656646345708').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1656646345708').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1656646345708').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
(function(jQuery) {
  var $module = jQuery('#m-1656646345704').children('.module');
...
(function(jQuery) {
    var $module = jQuery('#m-1656646345608').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1656646345727').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    (function( jQuery ){
  // var $module = jQuery('#m-1656646345725').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1656647229245').children('.module');   
    var navspeed = $module.data('navspeed'),
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1656647253434').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1656647070670').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1656769022905').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
  ...
  var $module = jQuery('#m-1601408704852').children('.module');
    ...
    jQuery(function() {
      var $module = jQuery('#m-1656647789434').children('.module');
    });
    ...
    jQuery(function() {
      var $module = jQuery('#m-1656647801571').children('.module');
    });
    ...
    jQuery(function() {
      var $module = jQuery('#m-1656647805757').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964328').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964328-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964283').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964323').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1656647964335').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964291').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964291-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964291-2').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964339').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1656647964301').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964326').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964326-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964233').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1656647964327').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1656647964314').children('.module');
    });
