  ...
  var $module = jQuery('#m-1601293871350').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1601293871350').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1601293871350');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1601293871350').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1601293871350').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1601293871350').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
      jQuery(function() {
  var $module = jQuery('#m-1601293721994').children('.module');
});
    jQuery(function() {
      var $module = jQuery('#m-1601293721943').children('.module');
    });
  jQuery(function() {
  ...
  var $module = jQuery('#m-1601293721996').children('.module');
    ...
    jQuery(function() {
        var $module = jQuery('#m-1601293722065').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293722065-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721911').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619519450155').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1601293721992').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721912').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721912-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721912-2').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619519481510').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1619519530797').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721886').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721886-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1601293721896').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619519490791').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1619519539281').children('.module');
    });
