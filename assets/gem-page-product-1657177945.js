...
(function( jQuery ){
  var $module = jQuery('#m-1657429604217').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    
    
(function(jQuery) {
  var $module = jQuery('#m-1657429604250').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1657429604187').children('.module');
  ...
  switch(style) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1657429604161').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1657429604213').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1657429604213').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1657429604213');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1657429604213').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1657429604213').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1657429604213').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
(function(jQuery) {
  var $module = jQuery('#m-1657429604144').children('.module');
...
(function(jQuery) {
    var $module = jQuery('#m-1657429604147').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1657429604249').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    (function( jQuery ){
  // var $module = jQuery('#m-1657429604180').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1657430431066').children('.module');   
    var navspeed = $module.data('navspeed'),
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1657430307039').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1657429864445').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1657429864467').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
  ...
  var $module = jQuery('#m-1616252277293').children('.module');
    ...
    jQuery(function() {
      var $module = jQuery('#m-1657429807563').children('.module');
    });
    ...
    jQuery(function() {
      var $module = jQuery('#m-1657429830120').children('.module');
    });
    ...
    jQuery(function() {
      var $module = jQuery('#m-1657429825137').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080204').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080204-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080167').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080253').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1657431080151').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080233').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080233-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080233-2').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080215').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1657431080280').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080299').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080299-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080249').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1657431080284').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1657431080224').children('.module');
    });
