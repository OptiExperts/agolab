  ...
  var $module = jQuery('#m-1619275121222').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1619275121222').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1619275121222');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1619275121222').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1619275121222').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1619275121222').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
      jQuery(function() {
  var $module = jQuery('#m-1619274696730').children('.module');
});
    jQuery(function() {
      var $module = jQuery('#m-1619274696714').children('.module');
    });
  jQuery(function() {
  ...
  var $module = jQuery('#m-1619274696746').children('.module');
    ...
    jQuery(function() {
      var $module = jQuery('#m-1619274696767').children('.module');
    });
    ...
    jQuery(function() {
        var $module = jQuery('#m-1619274696772').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696772-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696619').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619885155060').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696778').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696778-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696778-2').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619885149021').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696794').children('.module');
        $module.gfV3Product();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696794-1').children('.module');
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619274696644').children('.module');
        $module.gfV3ProductPrice();
    });
  
    jQuery(function() {
        var $module = jQuery('#m-1619885133994').children('.module');
        $module.gfV3ProductCartButton({ onItemAdded: function() {}});
    });
