...
jQuery(function() {
  try {
    var $module = jQuery('#m-1609183808864').children('.module');   
    ...
    jQuery(function() {
        var $module = jQuery('#m-1569781989035').children('.module');

        var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
        if(mode == 'production') {
            $module.find('button[type="submit"]').on('mouseover', function() {
                try {
                    localStorage.setItem('gemId', '#m-1569781989035');
                } catch(err) {}
            });
        ...
        jQuery(function() {
            var $module = jQuery('#m-1569782236994').children('.module');
            $module.gfV1Gmap();
